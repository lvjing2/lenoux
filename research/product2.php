        ...
        <ul class="product-items">
            <li>
                <a title="" target="_blank" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img2.png">
                </a>
            </li>
            <li>
                <a title="" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img2-1.gif">
                </a>
            </li>
            <li>
                <a title="" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img2-2.gif">
                </a>
            </li>
			 <li>
                <a title="" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img2-3.gif">
                </a>
            </li>
        </ul>
