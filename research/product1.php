        ...
        <ul class="product-items">
            <li>
                <a title="" target="_blank" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img1.png">
                </a>
            </li>
            <li>
                <a title="" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img1-1.png">
                </a>
            </li>
            <li>
                <a title="" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img1-2.png">
                </a>
            </li>
			 <li>
                <a title="" href="#">
                    <img  src="<?php echo SUBROOT;?>./imgs/research/product_imgs/img1-3.png">
                </a>
            </li>
        </ul>
