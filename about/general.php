...
<body>
	...
	<div id="banner_tabs" class="flexslider">
        <ul class="slides">
            <li>
                <img class="banner-img" alt="" style="background: url(<?php echo SUBROOT;?>./imgs/about/general/banner-1.png) no-repeat center;" src="<?php echo SUBROOT;?>./imgs/icons/alpha.png">
