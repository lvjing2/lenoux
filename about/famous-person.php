...
<body>
	...
	<div id="banner_tabs" class="flexslider">
        <ul class="slides">
            <li>
                <img class="banner-img" alt="" style="background: url(<?php echo SUBROOT;?>./imgs/about/famous-person/famous-1.1.png) no-repeat center;" src="<?php echo SUBROOT;?>./imgs/icons/alpha.png">
            ...
            <li>
                <img class="banner-img" alt="" style="background: url(<?php echo SUBROOT;?>./imgs/about/famous-person/famous-2.png) no-repeat center;" src="<?php echo SUBROOT;?>./imgs/icons/alpha.png">
