...
<body>
	...
	<div id="banner_tabs" class="flexslider">
        <ul class="slides">
            <li>
                <img class="banner-img" alt="" style="background: url(<?php echo SUBROOT;?>./imgs/about/famous-person/famous-1.1.png) no-repeat center;" src="<?php echo SUBROOT;?>./imgs/slide_imgs/alpha.png">
                
                <div id="general-text-on-img" class="wrapper-text-on-img clear">
                    <div class="text-on-img">
                        <div style="width: 200px; margin-left: 40px;">
                            <p style="color: #fff;">
                            唐纳德 诺曼（Donald Arthur Norman） 美国认知心理学家、计算机工程师、 工业设计家，认知科学学会的发起人 之一，关注人类社会学、行为学的研 究。代表作有《设计心理学》、《情 感化设计》等。
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <li>
                <img class="banner-img" alt="" style="background: url(<?php echo SUBROOT;?>./imgs/about/famous-person/famous-2.png) no-repeat center;" src="<?php echo SUBROOT;?>./imgs/slide_imgs/alpha.png">
                
                <div id="general-text-on-img" class="wrapper-text-on-img clear">
                    <div class="text-on-img" >
                        <div style="width: 200px; margin-left: 40px;">
                            <p>
                            唐玄辉（右） 台科大工商业设计系副教授， DITLDESIGN总监，专注于 用户体验服务设计创新。曾 主导多项弱势族群产品开发 案。研究与设计并重，有多 篇SCI期刊发表及拿下多项 国内设计竞赛金奖。于 学界与业界主持多场 情景故事法与设计 思考设计工作坊和 教育训练。
                            </p>
                        </div>
                    </div>
                </div>
